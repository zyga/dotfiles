" Vim syntax file
" Language:     QML
" Maintainer:   Christian Dywan <christian@twotoasts.de>
...
syn keyword qmlCommentTodo      TODO FIXME XXX contained
...
syn keyword qmlType		int bool double real string url color date variant alias
syn keyword qmlIdentifier	property signal
syn keyword qmlReserved		id
